...
public class Main_Ubelix_100k_INSERT {

	private String dataFilePath = "results_100k.zip";
	...
	public static void main(String[] args) {
		Main_Ubelix_100k_INSERT start = new Main_Ubelix_100k_INSERT();
		
		ArrayList<AnalysisResult> ars = start.readZipFile();
		start.storeAnalysisResults(ars);
	}

	public Main_Ubelix_100k_INSERT() {
